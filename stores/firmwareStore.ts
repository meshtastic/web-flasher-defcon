  ...
  state: () => {
    return {
      stable: [<FirmwareResource>{
        ...
        page_url: "https://github.com/meshtastic/defcontastic/releases/tag/v2.4.2.f805d10",
        zip_url: "https://github.com/meshtastic/defcontastic/releases/download/v2.4.2.f805d10/firmware-2.4.2.f805d10.zip",
